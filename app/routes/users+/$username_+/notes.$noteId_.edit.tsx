...
import { Form, useLoaderData, useNavigation, useFormAction } from '@remix-run/react'
        ...
        >
            <div className='flex flex-col gap-1'>
                ...
                <div>
                    {/* 🦉 NOTE: this is not an accessible label, we'll get to that in the accessibility exercises */}
                    <Label>Content</Label>
                    <TextArea name="content" defaultValue={data.note.content} required maxLength={10000}/>
                </div>
            </div>
